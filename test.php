	    ...
	    <div class="content-a">
	    	<div class="container">
	    		...
	    		<nav class="nav-container float-right" data-sr="enter right, over 1.3s">
	    			<ul class="nav-links">
	    				<li><a data-scroll href="#portfolio-boxes"><i class="fa fa-book"></i>Portfolio</a></li>
	    			...
	    			<ul class="nav-links bottom-spacing">
	    				<li><a class="float-right" data-scroll href="#connect"><i class="fa fa-phone"></i>Hire me!</a></li>
	    			</ul>
	    		</nav>
	    		...
	    		<div class="clear-fix container">
						...
						<p id="about-me-p">
							 Web Designer based in <strong>#yeg.</strong> Loves disruptive technology, photography &amp; videography.
						</p>
	        </div>
	    </div>
	</section>
